...
Microsoft Copilot Studio works seamlessly with Power Automate to fetch and process data from external sources. I created a flow that connects to NewsAPI and returns data for the agent.

<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-06-24-MS/flow_01.png" style="width: 550px;" />
</div>

1. Click **Create** and select **Instant cloud flow**.

<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-06-24-MS/flow_02.png" style="width: 550px;" />
</div>

2. For the trigger, choose **When Power Automate is called by Copilot Studio**.

<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-06-24-MS/flow_03.png" style="width: 550px;" />
</div>

3. Use an **HTTP GET** action to connect to the NewsAPI endpoint, with the API key generated before.

<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-06-24-MS/flow_04.png" style="width: 550px;" />
</div>

4. Add a **Parse JSON** step to extract specific fields (like headlines, descriptions, or URLs) from the API response.

5. Use **Append to String Variable** to format the output text that the agent will display.

6. Add **Return value(s) to Power Virtual Agents**, so the agent can display the news summary.
