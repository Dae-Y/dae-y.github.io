...
<div> <a href="https://github.com/Dae-Y/building-number-recognition">📘 Explore the Project on GitHub</a> </div>
...
1. **Normalisation**  
   Resize each character patch to a fixed size (e.g., 32×32 or 40×40), pad if necessary, and keep a small margin so strokes are not cut off.
...
<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-10-27-MP/MP11_02.png" style="width: 550px;" />
</div>

<div style="text-align: left; margin-bottom: 5px;">
  <img src="{{site.url}}/images/2025-10-27-MP/MP11_03.png" style="width: 550px;" />
</div>
